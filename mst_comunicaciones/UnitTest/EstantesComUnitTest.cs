...
{
    [TestClass]
    public class EstantesComUnitTest
    {
        ...
        public EstantesComUnitTest()
        {
            iComunicacion = new EstantesComunicacion();
        ...
        private async Task Guardar()
        {
            ...
            var enti = entidad = JsonConversor.ConvertirAObjeto<Estantes>(
