...
{
    [TestClass]
    public class ProveedoresComUnitTest
    {
        ...
        public ProveedoresComUnitTest()
        {
            iComunicacion = new ProveedoresComunicacion();
        ...
        private async Task Guardar()
        {
            ...
            var enti = entidad = JsonConversor.ConvertirAObjeto<Proveedores>(
