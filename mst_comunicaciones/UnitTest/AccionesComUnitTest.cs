...
{
    [TestClass]
    public class AccionesComUnitTest
    {
        private IAccionesComunicacion? iComunicacion = null;
        private Acciones? entidad = null;
        private List<Acciones>? lista = null;
        private static string token = null;
        private TokenHelper TokenHelper;



        public AccionesComUnitTest()
        {
            iComunicacion = new AccionesComunicacion();
        ...
        private async Task Guardar()
        {
            ...
            entidad = EntidadesHelper.ObtenerAcciones();
            ...
            var enti = entidad = JsonConversor.ConvertirAObjeto<Acciones>(
