...
namespace lib_presentaciones.Implementaciones
{
    public class AccionesPresentacion : IAccionesPresentacion
    {
        ...
        public async Task<List<Acciones>> Listar()
        {
        ...
        public async Task<List<Acciones>> Buscar(Acciones entidad, string tipo)
        {
            var lista = new List<Acciones>();
            var datos = new Dictionary<string, object>();
        ...
        public async Task<Acciones> Guardar(Acciones entidad)
        {
        ...
        public async Task<Acciones> Modificar(Acciones entidad)
        {
            if (entidad.Id == 0 || !entidad.Validar())
            {
                throw new Exception("lbFaltaInformacion");
        ...
        public async Task<Acciones> Borrar(Acciones entidad)
        {
            if (entidad.Id == 0 || !entidad.Validar())
            {
                throw new Exception("lbFaltaInformacion");
